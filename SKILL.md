...
When canonical rendering is proven, report “score X/100 under acceptance model 1.0.1 at target Y/100.” Otherwise label the number “preview score X/100,” set the applicable `non_canonical` status, and never call it accepted. Always include gates, stop reason, limitations, trace provenance, and retained artifacts. Never say only “X% accurate.”
